...
public final class Bottle implements Beverage {
    ...
    /**
     * Copy constructor kept for compatibility with existing DTO usage.
     * The baseUri parameter is intentionally unused here but preserved to avoid signature changes.
     */
