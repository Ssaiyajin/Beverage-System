...
public final class Bottle implements Beverage {
    ...
    /**
     * Compatibility copy constructor (baseUri is unused but kept to preserve existing call sites).
     */
    ...
    public void setName(String name) {
        final String n = Objects.requireNonNull(name, "name must not be null").trim();
    ...
    public void setSupplier(String supplier) {
        final String s = Objects.requireNonNull(supplier, "supplier must not be null").trim();
